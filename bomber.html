...
<div class="container">
    ...
    <form id="apiForm" method="POST" onsubmit="showPopup(); return false;">
        ...
        <button type="button" onclick="window.location.href='https://t.me/sujon_bevies'">Join Telegram Channel</button>
    </form>
    <div id="message"></div>
    <div class="credit">
        <p>Credit: <a href="https://t.me/sujonbevies2" target="_blank">SUJON BE'VIES</a></p>
    </div>
</div>
